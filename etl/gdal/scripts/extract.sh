...
ogr2ogr -f GeoJSON data/subway_ada_fill.geojson PG:"dbname=$POSTGRES_DB host=etl-postgis-1 user=$POSTGRES_USER port=5432" -sql "SELECT id, stop_name, daytime_routes, ada, fill FROM subway_ada"
