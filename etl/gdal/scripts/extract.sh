...
ogr2ogr -f GeoJSON data/subway_line_fill.geojson PG:"dbname=$POSTGRES_DB host=etl-postgis-1 user=$POSTGRES_USER port=5432" -sql "SELECT id, service, fill FROM subway_line"
